                        ...
                        <select class="form-select" id="product_search">
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" 
                                    ...
                                    {{ $product->name }} - {{ number_format($product->selling_price, 2) }}€ (Stock: {{ $product->stock_quantity }})
                                </option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3" id="prescription_number_field" style="display: none;">
    ...
    row.innerHTML = `
        ...
        <td>
            <input type="number" class="form-control quantity-input" name="products[${productCounter}][quantity]" 
                   value="1" min="1" max="${product.stock}" onchange="updateRowTotal(this.closest('tr'))">
        </td>
        <td>
